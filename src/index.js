...
import TouristSpotsID from "./components/TouristSpots/TouristSpotsID"
...
import ActivityID from "./components/Activity/ActivityID"
  ...
  return (
    ...
    <BrowserRouter basename="/TravelApp">
          <Routes>
                ...
                <Route path="/Activity/:id" element={<ActivityID/>}></Route>
